...
var goroutinesToIgnore = []string{
	...
	"goroutine in C code",
	// Ignore the http read/write goroutines. gce metadata.OnGCE() was leaking these, root cause unknown.
	//
...
// RegisterIgnoreGoroutine appends s into the ignore goroutine list. The goroutines whose stack trace contains
// s will not be identified as leaked goroutines. Not thread-safe, only call this function in init().
